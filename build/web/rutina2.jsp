...
<body>
  ...
  <script>
    ...
    <div class="fondo-ejercicio">
      ...
      <div>
        <p class="texto-ejercicio">
          Con los pies abiertos a la altura de los hombros, espalda en posición neutral con las rodillas centradas sobre sus pies, doblar las rodillas lentamente, también caderas y tobillos, bajando hasta alcanzar un ángulo de 90 grados. Inhalar mientras baja y exhalar mientras regresa a la posición inicial. (30 segundos)
        </p>
      </div>
      <div class="div-imagen">
    ...
    <div class="fondo-ejercicio">
      ...
      <div>
        <p class="texto-ejercicio">
          Acerca el torso a las rodillas sin levantar la espalda del suelo y con los brazos estirados sobre tu cabeza: la clave de unas abdominales bien realizadas es hacer presión en la musculatura del estómago, no forzar otras partes de nuestro cuerpo. Mantén los pies en el suelo en todo momento y aprieta el estómago mientras realizas el movimiento. (30 segundos)
        </p>
      </div>
      <div class="div-imagen">
        <img class="imagen-ejercicio" src="img/muscular.gif" alt="imagen1">
    ...
    <div class="fondo-ejercicio">
      ...
      <div>
        <p class="texto-ejercicio">
          Recuéstate de lado con el apoyo de una mano en el suelo y el pie opuesto en el suelo delante de la pierna, a modo de apoyo. Con la pierna superior ligeramente flexionada y en reposo mientras la pierna inferior, más cercana al suelo, se eleva hacia arriba en contra de la gravedad. (30 segundos)
        </p>
      </div>
      <div class="div-imagen">
        <img class="imagen-ejercicio" src="img/muscular.gif" alt="imagen1">
