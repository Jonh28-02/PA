<%-- 
    Document   : semanas
    Created on : 13/12/2021, 01:36:37 PM
    Author     : river
--%>
...
<body>
    ...
    <form action="editar" method="POST" id="registro">
        ...
        <div class="form">
            ...
            <a href="rutina1.jsp">SEMANA 1</a>
            <br><br>
            <a href="rutina2.jsp">SEMANA 2</a>
            <br><br>
            <a href="rutina 3.jsp">SEMANA 3</a>
            <br><br>
            <a href="rutina1.jsp">SEMANA 4</a>
            <br><br>
