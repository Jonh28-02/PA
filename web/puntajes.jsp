<%-- 
    Document   : puntajes
    Created on : 10/06/2021, 10:31:55 AM
    Author     : river
--%>
...
<%
 ...
 List<Puntaje> lista=AccionesPuntaje.getAllPuntajes();
...
<body>
	...
	<div id="main-container">
		...
		<table>
			<thead>
				<tr>
					<th>Nombre</th><th>Lecciones Completadas</th><th>Puntaje</th>
				</tr>
			</thead>
                        <%for(Puntaje b: lista){%>
			<tr>
				<td><%=b.getNom_usu()%></td><td><%=b.getLecciones_completadas()%></td><td><%=b.getPuntaje()%></td>
			</tr>
